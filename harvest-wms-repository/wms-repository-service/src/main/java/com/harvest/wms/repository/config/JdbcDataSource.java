package com.harvest.wms.repository.config;
...
public class JdbcDataSource {
    ...
    private final static String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/farmland_wms";
    private final static String USERNAME = "root";
    private final static String PASSWORD = "123456";

    @Bean(name = "wms_dataSource")
    public DataSource dataSource() throws SQLException {
        DruidDataSource dataSource = new DruidDataSource();
        dataSource.setName("node-wms-mysql");
    ...
    @Primary
    @Bean(name = JdbcDataSource.WMS_TRANSACTION_MANAGER)
    public DataSourceTransactionManager dataSourceTransactionManager() throws SQLException {
        return new DataSourceTransactionManager(dataSource());
    }

    @Bean(value = JdbcDataSource.WMS_TRANSACTION_TEMPLATE)
