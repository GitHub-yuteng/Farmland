package com.harvest.goods.repository.utils;
...
public class MySqlGeneratorUtils {
    ...
    private static final String ENTITY_PATH = PARENT_DIR + "/harvest-goods-repository/goods-repository-entity/src/main/java/com/harvest/goods/repository/entity";
    private static final String MAPPER_PATH = PARENT_DIR + "/harvest-goods-repository/goods-repository-service/src/main/java/com/harvest/goods/repository/mapper";
    private static final String XML_PATH = PARENT_DIR + "/harvest-goods-repository/goods-repository-service/src/main/resources/mapper";

    private final static String MYSQL_IP = "jdbc:mysql://localhost:3306/farmland_goods";
    ...
    private static void execute(String table) {
        FastAutoGenerator.create(MYSQL_IP, USERNAME, PASSWORD)
                ...
                .packageConfig(builder -> builder
                        ...
                        .serviceImpl("")
                        .service("")
                        .entity("com.harvest.goods.repository.entity")
                        .mapper("com.harvest.goods.repository.mapper")
                        .xml("com.harvest.goods.repository.mapper"))
